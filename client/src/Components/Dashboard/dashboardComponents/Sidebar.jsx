...
import { MdPowerSettingsNew } from 'react-icons/md'; // Import the power icon
...
const Sidebar = () => {
    ...
    return (
        <div className={`bg-[#121417] h-[calc(100vh-3rem)] border-r border-r-[#9fadbc29] transition-all linear duration-500 flex-shrink-0 flex flex-col ${collapsed ? 'w-[42px]' : 'w-[280px]'}`} >
            ...
            <div className="p-3 flex justify-center border-t border-t-[#9fadbc29]">
                <button
                    className='hover:bg-slate-600 rounded-sm p-1 flex items-center'
